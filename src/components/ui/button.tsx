  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        healthcare: "bg-healthcare-green text-healthcare-green-foreground hover:bg-healthcare-green-hover shadow-glow-healthcare",
        glass: "glass-card text-foreground hover:bg-glass border-glass-border backdrop-blur-sm",
        hero: "bg-gradient-primary text-primary-foreground hover:shadow-glow-primary transition-bounce",
        "glass-hero": "glass-card text-foreground hover:shadow-glow-primary border-primary/30 backdrop-blur-md",
      },
      size: {
